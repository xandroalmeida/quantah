...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        return [
            ...
            // Versão do app: `version` é o rótulo humano (tag) do carimbo; `assetVersion` é a
            // assinatura do bundle de boot, comparada ao endpoint /version para auto-atualizar.
            'version' => AppVersion::label(),
            'assetVersion' => AppVersion::asset(),
        ];
    }
